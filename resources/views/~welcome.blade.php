	...
	<div class="container">
	    <div class="welcomeIcons">
            ...
            <div class="welcomeIcon">
                <a href="jobseeker"><img class="col-md-3 col-sm-3 col-xs-3" src="../img/index/icons-01.png"></a>
                <p>
                    Student
                </p>
            </div>
            <div class="welcomeIcon">
                <a href="jobseeker"><img class="col-md-3 col-sm-3 col-xs-3" src="../img/index/icons-02.png"></a>
                <p>
                    Graduate
                </p>
            </div>
            <div class="welcomeIcon">
                <a href="jobseeker"><img class="col-md-3 col-sm-3 col-xs-3" src="../img/index/icons-03.png"></a>
                <p>
                    Intern
                </p>
            </div>
            <div class="welcomeIcon">
                <a href="employer" ><img class="col-md-3 col-sm-3 col-xs-3" src="../img/index/icons-04.png"></a>
                <p>
                    Employer
                </p>
            </div>
