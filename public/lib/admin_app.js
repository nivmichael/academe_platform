...
.config(['$locationProvider', '$stateProvider', '$urlRouterProvider', '$httpProvider',
    function($locationProvider, $stateProvider, $urlRouterProvider, $httpProvider) {
      ...
      $stateProvider
        ...
        .state('admin.tables.sys_param_values', {
          url: "/sys_param_values",
          controller: 'TController',   
          templateUrl: '../partials/db/table.html'  
        })
        .state('admin.tables.param', {
          url: "/param",
          controller: 'TController',   
          templateUrl: '../partials/db/table.html'  
        })
        .state('admin.tables.doc_param', {
          url: "/doc_param",
          controller: 'TController',   
          templateUrl: '../partials/db/table.html'  
        })
        .state('admin.tables.param_type', {
          url: "/param_type",
          controller: 'TController',   
          templateUrl: '../partials/db/table.html'  
        })
        .state('admin.tables.doc_type', {
          url: "/doc_type",
          controller: 'TController',   
          templateUrl: '../partials/db/table.html'  
        })
        .state('admin.tables.param_value', {
          url: "/param_value",
          controller: 'TController',   
          templateUrl: '../partials/db/table.html'  
        })
